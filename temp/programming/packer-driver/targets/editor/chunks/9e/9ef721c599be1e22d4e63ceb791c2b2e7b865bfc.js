System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Button, Label, Sprite, ResultModal, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, ChoicesModal;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ResultModal = _unresolved_2.ResultModal;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("ChoicesModal", ChoicesModal = (_dec = ccclass('ChoicesModal'), _dec2 = property(Button), _dec3 = property(Label), _dec4 = property(Sprite), _dec5 = property(_crd && ResultModal === void 0 ? (_reportPossibleCrUseOfResultModal({
        error: Error()
      }), ResultModal) : ResultModal), _dec(_class = (_class2 = class ChoicesModal extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "resultModal", _descriptor4, this);
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "resultModal", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=9ef721c599be1e22d4e63ceb791c2b2e7b865bfc.js.map