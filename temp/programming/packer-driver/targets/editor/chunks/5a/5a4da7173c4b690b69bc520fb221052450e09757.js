System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, Button, Vec3, Sprite, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, QuestionModal;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("QuestionModal", QuestionModal = (_dec = ccclass('QuestionModal'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Sprite), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Node), _dec(_class = (_class2 = class QuestionModal extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "nextModal", _descriptor8, this);
        }
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "nextModal", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=5a4da7173c4b690b69bc520fb221052450e09757.js.map