System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, SpriteFrame, randomRangeInt, GestureData, _dec, _dec2, _class, _class2, _descriptor, _class3, _crd, ccclass, property, QuizDataBase;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'SpriteFrame', 'Sprite', 'random', 'randomRangeInt']);
      ...
      _export("QuizDataBase", QuizDataBase = (_dec = ccclass('QuizDataBase'), _dec2 = property(SpriteFrame), _dec(_class = (_class2 = (_class3 = class QuizDataBase extends Component {
        ...
        GestureDataInitialize() {
          for (var i = 0; i < 6; i++) {
            var data = new (_crd && GestureData === void 0 ? (_reportPossibleCrUseOfGestureData({
              error: Error()
...
//# sourceMappingURL=e05630b33b4bfc932a9e3ff432ae8046a242e417.js.map