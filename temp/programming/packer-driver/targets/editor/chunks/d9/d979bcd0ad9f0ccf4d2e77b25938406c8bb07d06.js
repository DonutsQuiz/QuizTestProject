    ...
    execute: function () {
      ...
      _export("GestureQuiz", GestureQuiz = (_dec = ccclass('GestureQuiz'), _dec(_class = class GestureQuiz extends (_crd && QuizComponent === void 0 ? (_reportPossibleCrUseOfQuizComponent({
        ...
        SetQuiz() {
          ...
          (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
          }), GameManager) : GameManager).Instance().GetGameInfo().qSprite = this.mData.mSprite;
          ...
          this.mData.mSprite = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
          }), GameManager) : GameManager).Instance().GetGameInfo().qSprite; // 問題文
...
//# sourceMappingURL=d979bcd0ad9f0ccf4d2e77b25938406c8bb07d06.js.map