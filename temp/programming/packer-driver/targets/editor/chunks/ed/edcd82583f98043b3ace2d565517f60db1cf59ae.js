System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Button, GestureQuiz, QuizModalManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, QuizManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("QuizManager", QuizManager = (_dec = ccclass('QuizManager'), _dec2 = property(Button), _dec3 = property(Number), _dec(_class = (_class2 = (_class3 = class QuizManager extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "startButton", _descriptor, this);

          _initializerDefineProperty(this, "raundMax", _descriptor2, this);
        ...
        OnUpdate() {
          ...
          if ((_crd && QuizModalManager === void 0 ? (_reportPossibleCrUseOfQuizModalManager({
            ...
            (_crd && QuizModalManager === void 0 ? (_reportPossibleCrUseOfQuizModalManager({
              error: Error()
            }), QuizModalManager) : QuizModalManager).Instance().GetResultModal().isNext = false;
          }
        }
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "raundMax", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=edcd82583f98043b3ace2d565517f60db1cf59ae.js.map