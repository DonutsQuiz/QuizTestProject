System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Button, Label, Sprite, Vec3, ChipControll, Timer, GameManager, QuizModalManager, BetModal, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _crd, ccclass, property, ChoicesModal;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ChoicesModal", ChoicesModal = (_dec = ccclass('ChoicesModal'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Label), _dec6 = property(Sprite), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(_crd && BetModal === void 0 ? (_reportPossibleCrUseOfBetModal({
        error: Error()
      }), BetModal) : BetModal), _dec12 = property(Button), _dec13 = property(Button), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(_crd && Timer === void 0 ? (_reportPossibleCrUseOfTimer({
        error: Error()
      }), Timer) : Timer), _dec18 = property(_crd && ChipControll === void 0 ? (_reportPossibleCrUseOfChipControll({
        error: Error()
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "resultButton", _descriptor12, this);

          _initializerDefineProperty(this, "liverAnswerFrameSprite", _descriptor13, this);

          _initializerDefineProperty(this, "userAnswerFrameSprite", _descriptor14, this);

          _initializerDefineProperty(this, "resultModal", _descriptor15, this);

          _initializerDefineProperty(this, "timer", _descriptor16, this);

          _initializerDefineProperty(this, "chipAnim", _descriptor17, this);
        ...
        start() {
          ...
          this.resultButton.node.on(Button.EventType.CLICK, this.Next, this);
      ...
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "resultButton", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "liverAnswerFrameSprite", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "userAnswerFrameSprite", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "resultModal", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "timer", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "chipAnim", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=ca7949a37432f33f422ea33d14af8bff1be5ed99.js.map