      ...
      _export("GestureQuiz", GestureQuiz = (_dec = ccclass('GestureQuiz'), _dec(_class = class GestureQuiz extends (_crd && QuizComponent === void 0 ? (_reportPossibleCrUseOfQuizComponent({
        ...
        SetQuiz() {
          ...
          if ((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            ...
            (_crd && QuizModalManager === void 0 ? (_reportPossibleCrUseOfQuizModalManager({
              error: Error()
            }), QuizModalManager) : QuizModalManager).Instance().GetQuestionModal().SetSprite(this.mSprite = this.mData.mSprite);
          } else {
            (_crd && QuizModalManager === void 0 ? (_reportPossibleCrUseOfQuizModalManager({
              error: Error()
            ...
            (_crd && QuizModalManager === void 0 ? (_reportPossibleCrUseOfQuizModalManager({
              error: Error()
            }), QuizModalManager) : QuizModalManager).Instance().GetQuestionModal().SetSprite(this.mSprite = null);
          } // 選択肢
...
//# sourceMappingURL=4923b9f0864c36edcf7ff35a25bf7faf49c6e74b.js.map