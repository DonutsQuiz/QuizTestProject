  ...
  return {
    ...
    execute: function () {
      ...
      _export("ChoicesModal", ChoicesModal = (_dec = ccclass('ChoicesModal'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Label), _dec6 = property(Sprite), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(_crd && BetModal === void 0 ? (_reportPossibleCrUseOfBetModal({
        error: Error()
      }), BetModal) : BetModal), _dec12 = property(Button), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(_crd && Timer === void 0 ? (_reportPossibleCrUseOfTimer({
        error: Error()
      }), Timer) : Timer), _dec16 = property(_crd && ChipControll === void 0 ? (_reportPossibleCrUseOfChipControll({
        error: Error()
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "timer", _descriptor14, this);

          _initializerDefineProperty(this, "chipAnim", _descriptor15, this);
      ...
      }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "timer", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "chipAnim", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=d2a495e053a16b2288379b2e48f1ada8f778e315.js.map