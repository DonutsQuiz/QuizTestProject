System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Slider', 'Button', 'Label', 'labelAssembler', 'convertUtils']);
      ...
      _export("BetModal", BetModal = (_dec = ccclass('BetModal'), _dec2 = property(Node), _dec3 = property(Slider), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Label), _dec7 = property(Button), _dec(_class = (_class2 = class BetModal extends Component {
        ...
        BetSlider() {
          this.betValue = this.coins * this.betSlider.progress;
...
//# sourceMappingURL=f08e9b210c2ab07810d99e63e3cda0ffcea10cf8.js.map