System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, instantiate, Prefab, ChoicesModal, OverallResultModal, QuestionModal, ResultModal, GameManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _class3, _crd, ccclass, property, ModalType, QuizModalManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("QuizModalManager", QuizModalManager = (_dec = ccclass('QuizModalManager'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec(_class = (_class2 = (_class3 = class QuizModalManager extends Component {
        ...
        update(deltaTime) {//this.DebugClientMode();
        }
        ...
        ChangeModal(nextType) {
          if (nextType === 'Question') {
            ...
            this.question.Initialize((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              error: Error()
            }), GameManager) : GameManager).Instance().GetGameInfo().qType);
...
//# sourceMappingURL=3f242e986b79c3075dad4d1bd271bd7a70d669e7.js.map