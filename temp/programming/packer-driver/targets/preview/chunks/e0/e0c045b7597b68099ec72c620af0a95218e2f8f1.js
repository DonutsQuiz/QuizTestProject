System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, math, GameManager, QuizManager, QuizModalManager, GestureData, QuizDataBase, QuizComponent, _dec, _class, _crd, ccclass, property, GestureQuiz;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GestureData = _unresolved_5.GestureData;
    }, function (_unresolved_6) {
      QuizDataBase = _unresolved_6.QuizDataBase;
    }, function (_unresolved_7) {
      QuizComponent = _unresolved_7.QuizComponent;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GestureQuiz", GestureQuiz = (_dec = ccclass('GestureQuiz'), _dec(_class = class GestureQuiz extends (_crd && QuizComponent === void 0 ? (_reportPossibleCrUseOfQuizComponent({
        ...
        SetQuiz() {
          ...
          var index = 0;
          var tempdata = new (_crd && GestureData === void 0 ? (_reportPossibleCrUseOfGestureData({
            error: Error()
          }), GestureData) : GestureData)[3]();
          (_crd && QuizModalManager === void 0 ? (_reportPossibleCrUseOfQuizModalManager({
            error: Error()
            ...
            if (i != this.mData.mAnswer) {
              ...
              do {
                ...
                for (var n = 0; n < (_crd && QuizManager === void 0 ? (_reportPossibleCrUseOfQuizManager({
                  ...
                  if ((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
                    error: Error()
                  }), GameManager) : GameManager).Instance().GetGameInfo().qIncSprite[n] === null) {
                    (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
                      error: Error()
                    }), GameManager) : GameManager).Instance().GetGameInfo().qIncSprite[n] = tempdata.mSprite;
                    result = true;
...
//# sourceMappingURL=e0c045b7597b68099ec72c620af0a95218e2f8f1.js.map