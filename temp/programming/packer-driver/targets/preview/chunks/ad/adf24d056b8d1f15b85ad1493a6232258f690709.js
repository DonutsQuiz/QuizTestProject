System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Button, Label, Sprite, Vec3, ChipControll, Timer, GameManager, QuizModalManager, BetModal, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _crd, ccclass, property, ChoicesModal;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ChoicesModal", ChoicesModal = (_dec = ccclass('ChoicesModal'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Sprite), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(_crd && BetModal === void 0 ? (_reportPossibleCrUseOfBetModal({
        error: Error()
      }), BetModal) : BetModal), _dec13 = property(Button), _dec14 = property(Button), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(_crd && Timer === void 0 ? (_reportPossibleCrUseOfTimer({
        error: Error()
        ...
        DontClickButton() {
          this.debugDontClick = true; // ボタンを消す

          for (var buttons of this.buttonList) {
            buttons.node.active = false;
          } // ラベルを消す


          for (var labels of this.betLabelList) {
            labels.node.active = false;
          }
        }
        ...
        DebugModalUpdate() {
          if ((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            ...
            if ((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              ...
              if (this.debugDontClick) {
                for (var labels of this.betLabelList) {
                  labels.node.active = true;
                }
              }
            } else {
              if (this.debugDontClick) {
                for (var _labels of this.betLabelList) {
                  _labels.node.active = false;
                }
              }
            }
          }
...
//# sourceMappingURL=adf24d056b8d1f15b85ad1493a6232258f690709.js.map