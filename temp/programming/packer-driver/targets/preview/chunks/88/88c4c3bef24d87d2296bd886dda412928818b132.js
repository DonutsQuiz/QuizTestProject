System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, math, GestureDataBase, QuizComponent, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, GestureQuiz;
  ...
  function _reportPossibleCrUseOfGestureData(extras) {
    _reporterNs.report("GestureData", "./DataBase/GestureData", _context.meta, extras);
  }

  function _reportPossibleCrUseOfGestureDataBase(extras) {
    _reporterNs.report("GestureDataBase", "./DataBase/GestureDataBase", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      QuizComponent = _unresolved_3.QuizComponent;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GestureQuiz", GestureQuiz = (_dec = ccclass('GestureQuiz'), _dec2 = property(_crd && GestureDataBase === void 0 ? (_reportPossibleCrUseOfGestureDataBase({
        ...
        SetQuiz() {
          ...
          this.questionModal.SetSprite(this.mSprite = this.mData.mSprite); // 選択肢
...
//# sourceMappingURL=88c4c3bef24d87d2296bd886dda412928818b132.js.map