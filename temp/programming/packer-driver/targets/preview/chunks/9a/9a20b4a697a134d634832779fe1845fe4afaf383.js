System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Button, Label, Color, Sprite, QuizModalManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, ResultModal;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ResultModal", ResultModal = (_dec = ccclass('ResultModal'), _dec2 = property(Button), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Sprite), _dec(_class = (_class2 = class ResultModal extends Component {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=9a20b4a697a134d634832779fe1845fe4afaf383.js.map