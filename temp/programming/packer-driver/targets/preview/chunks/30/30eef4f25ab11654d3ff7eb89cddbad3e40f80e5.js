System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Button, QuizModalManager, UserInfomation, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, OverallResultModal;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("OverallResultModal", OverallResultModal = (_dec = ccclass('OverallResultModal'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Label), _dec(_class = (_class2 = class OverallResultModal extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "rankLabel", _descriptor5, this);
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "rankLabel", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=30eef4f25ab11654d3ff7eb89cddbad3e40f80e5.js.map