System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Button, Label, Sprite, ChipControll, Timer, GameManager, QuizModalManager, BetModal, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _crd, ccclass, property, ChoicesModal;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ChoicesModal", ChoicesModal = (_dec = ccclass('ChoicesModal'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Label), _dec6 = property(Sprite), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(_crd && BetModal === void 0 ? (_reportPossibleCrUseOfBetModal({
        error: Error()
      }), BetModal) : BetModal), _dec12 = property(Button), _dec13 = property(_crd && Timer === void 0 ? (_reportPossibleCrUseOfTimer({
        error: Error()
      }), Timer) : Timer), _dec14 = property(_crd && ChipControll === void 0 ? (_reportPossibleCrUseOfChipControll({
        error: Error()
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "chipAnim", _descriptor13, this);
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "chipAnim", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=5aeaaf90bea3cadb5e928e833f6c7da751aed72a.js.map