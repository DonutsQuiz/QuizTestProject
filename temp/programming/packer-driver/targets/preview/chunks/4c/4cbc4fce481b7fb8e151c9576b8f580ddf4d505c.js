System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Button, QuizModalManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, TestMenu;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TestMenu", TestMenu = (_dec = ccclass('TestMenu'), _dec2 = property(Button), _dec3 = property(_crd && QuizModalManager === void 0 ? (_reportPossibleCrUseOfQuizModalManager({
        error: Error()
      }), QuizModalManager) : QuizModalManager), _dec(_class = (_class2 = class TestMenu extends Component {
        constructor() {
          super(...arguments);
        ...
        ClickFunction(name) {
          this.modalManager.GetQuestionModal().Initialize(name);
        }
...
//# sourceMappingURL=4cbc4fce481b7fb8e151c9576b8f580ddf4d505c.js.map