System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Button, QuizModalManager, UserInfomation, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, OverallResultModal;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'PageView', 'Label', 'Button', 'labelAssembler']);
      ...
      _export("OverallResultModal", OverallResultModal = (_dec = ccclass('OverallResultModal'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Label), _dec7 = property(Label), _dec(_class = (_class2 = class OverallResultModal extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "rankChangeButton", _descriptor4, this);

          _initializerDefineProperty(this, "rankChangeLabel", _descriptor5, this);

          _initializerDefineProperty(this, "rankLabel", _descriptor6, this);
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "rankChangeButton", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "rankChangeLabel", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "rankLabel", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=4cfc07bd5042370585dd08371aeddee6a57025df.js.map