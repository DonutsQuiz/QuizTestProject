System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Button, Label, Sprite, Vec3, ChipControll, Timer, GameManager, QuizManager, QuizModalManager, BetModal, ResultModal, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _crd, ccclass, property, ChoicesModal;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      QuizManager = _unresolved_5.QuizManager;
    }, function (_unresolved_6) {
      QuizModalManager = _unresolved_6.QuizModalManager;
    }, function (_unresolved_7) {
      BetModal = _unresolved_7.BetModal;
    }, function (_unresolved_8) {
      ResultModal = _unresolved_8.ResultModal;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("ChoicesModal", ChoicesModal = (_dec = ccclass('ChoicesModal'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Button), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Sprite), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(_crd && BetModal === void 0 ? (_reportPossibleCrUseOfBetModal({
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < (_crd && QuizManager === void 0 ? (_reportPossibleCrUseOfQuizManager({
            ...
            this.oddsLabelList[i].string = "X" + (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              error: Error()
            }), GameManager) : GameManager).Instance().GetGameInfo().odds[i].toString();
            this.betLabelList[i].string = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              error: Error()
            }), GameManager) : GameManager).Instance().GetGameInfo().totalBet[i].toString() + "コイン";
          } // 時間切れの処理
        ...
        DontClickButton(is) {
          for (var buttons of this.buttonList) {
...
//# sourceMappingURL=54d93ceae89e0158ee0d036535d36787e62a15b7.js.map