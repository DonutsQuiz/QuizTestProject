System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Button, QuizManager, QuizModalManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, TestMenu;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TestMenu", TestMenu = (_dec = ccclass('TestMenu'), _dec2 = property(Button), _dec3 = property(_crd && QuizManager === void 0 ? (_reportPossibleCrUseOfQuizManager({
        error: Error()
      }), QuizManager) : QuizManager), _dec(_class = (_class2 = class TestMenu extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "button", _descriptor, this);

          _initializerDefineProperty(this, "manager", _descriptor2, this);
        }
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "manager", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=8fc0cfa438282a314138d9862224fa02087a9369.js.map